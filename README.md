...
Copie o arquivo .env.example para criar um .env que será usado para configurar o ambiente:

```bash
$ cp .env.example .env
```

Suba os serviços necessários usando Docker:
...
To access the application directly through the browser, use:

- **Main URL**: http://localhost:3001

For authentication with OAuth, use the URLs below:
